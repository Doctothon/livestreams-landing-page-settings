...
program
    ...
    .option('--reporter-htmlextra-kibanaUrl', 'Specify the kibana url server')
    .option('--reporter-htmlextra-serviceName', 'Specify the service name to retrieve the APM kibana dashboard');
