                    ...
                    <div class="col-sm-12 mb-3">
                        ...
                        <div class="card border-info" style="width: 50rem;">
                            ...
                            <span><i class="fas fa-info-circle"></i></span><strong> Request URL:</strong> <a href="{{request.url}}" target="_blank">{{request.url}}</a><br>
                                        ...
                                        {{#if (eq key "traceId")}}
                                        <span><i class="fas fa-info-circle"></i></span><strong> Performance Stats:</strong> <a href="{{@root.kibanaUrl}}/app/apm/services/{{@root.serviceName}}/overview?environment=ENVIRONMENT_ALL&kuery=trace.id%20:%20{{value}}&rangeFrom={{#getKibanaFromDate}}{{/getKibanaFromDate}}&rangeTo={{#getKibanaToDate}}{{/getKibanaToDate}}&comparisonEnabled=true&comparisonType=day&transactionType=request
                                        " target="_blank">Kibana request performance report</a><br>
                                        {{/if}}
                                        {{/each}}
                            </div>
                        </div>
