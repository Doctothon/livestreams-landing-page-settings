...
PostmanHTMLExtraReporter = function (newman, options, collectionRunOptions) {
    ...
    handlebars.registerHelper('getKibanaFromDate', () => {
        return moment().add(-5, "minutes").toISOString();
    })

    handlebars.registerHelper('getKibanaToDate', () => {
        return moment().add(5, "minutes").toISOString();
    })
    ...
    newman.on('beforeDone', function () {
        ...
        console.log("ici")
        console.log("\n\n\n options.kibanaUrl : "+options.kibanaUrl+"\n")
        ...
        this.exports.push({
            ...
            content: compiler({
                ...
                kibanaUrl: options.kibanaUrl || 'http://localhost:5601',
                serviceName: options.serviceName || 'ms-salarie',
